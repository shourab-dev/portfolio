    ...
    <div id="smooth-wrapper">
        ...
        <nav class="navbar navbar-expand-lg bord">
            <div class="container">
                ...
                <!-- Logo -->
                <a class="logo icon-img-100" href="home-personal.html#">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="home-personal.html#"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item">
                                    <a href="home-personal.html#0">Classic Grid <i
                                            class="fas fa-angle-right icon-arrow"></i></a>
                                ...
                                <li class="dropdown-item">
                                    <a href="home-personal.html#0">Masonry <i
                                            class="fas fa-angle-right icon-arrow"></i></a>
                                    <ul class="dropdown-side">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="home-personal.html#"
                                role="button" aria-haspopup="true" aria-expanded="false"><span
                                    class="rolling-text">Shop</span></a>
                            <div class="dropdown-menu">
